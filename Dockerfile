...
RUN apk add --update --no-cache g++ py3-bottle py3-requests make python tmux curl bash git --repository http://dl-cdn.alpinelinux.org/alpine/v3.7/main/ nodejs=8.9.3-r1 \
